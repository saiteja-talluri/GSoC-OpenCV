...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Training of lbf facial landmark algorithm.')
    ...
    parser.add_argument('--lbf_model', type=str, help="Path to save the lbf trained model file",
                        default=os.path.join(os.path.dirname(os.path.realpath(__file__)),'models','LBF_train.yaml'))
