...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Demonstration of aam facial landmark algorithm.')
    ...
    parser.add_argument('--aam_model', type=str, help="Path to the aam trained model file",
                        default=os.path.join(os.path.dirname(os.path.realpath(__file__)),'models','AAM.yaml'))
