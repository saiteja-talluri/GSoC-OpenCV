...
bool parseArguments(int argc, char** argv,
    ...
    const String keys =
        ...
        "{ help h usage ?     |      | facemark_demo_aam -face-cascade -eyes-cascade -model -test_images \n"
             " example: aam-demo models/face_cascade.xml models/eyes_cascade.xml AAM.yaml test/images_test.txt }"
    ;
