...
bool parseArguments(int argc, char** argv,
    ...
    const String keys =
        ...
        "{ @m model-name      |      | (required) name of the AAM model to be loaded}"
        ...
        "{ help h usage ?     |      | facemark_demo_aam -face-cascade -eyes-cascade -model -images -annotations [-t]\n"
             " example: facemark_demo_aam models/face_cascade.xml models/eyes_cascade.xml models/AAM.yaml train/images_train.txt train/points_train.txt}"
    ;
